...
class VendingMachine:
    ...
    restocks = 0
    funds = 0
    def __init__(self, commodity, charge):
    ...
    def vend(self):
        if self.restocks == 0:
        ...
        elif self.funds < self.charge:
            return f'You must add ${self.charge - self.funds} more funds.'
        elif self.funds == self.charge:
            self.funds = 0
            self.restocks -= 1
            ...
            self.restocks -= 1
            rest = self.funds - self.charge
            self.funds = 0
            return f'Here is your {self.commodity} and ${rest} change.'
    ...
    def restock(self, restock_num):
        self.restocks += restock_num
        return f'Current {self.commodity} stock: {self.restocks}'
...
def two_list(vals, amounts):
    ...
    if amounts[0] == 0:
        vals = vals[1:]
        amounts = amounts[1:]
    return Link(ele, two_list(vals, amounts))
